...
- Kept the separate PostgreSQL hardening worktree untouched; provider setup, durable storage, connected QM/Fly runtime deployment, recovery, UAT, merge, and production acceptance remain open gates.
