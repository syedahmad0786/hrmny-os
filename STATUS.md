...
- Added the server-only QM PostgreSQL repository at `56b20af`: two tables, atomic replay, current-policy locking, strict stored-row parsing, append-only receipts, and no memory fallback or effect executor.
