...
5. **Planning and reporting** — Calendar, Timeline, Files, My Tasks, Inbox, search, Gantt, goals, portfolios, statuses, task/project/goal/portfolio charts (including numeric custom-field totals/averages and team/specific-object/date filters), saved/shared multi-widget dashboards, workload, capacity, budgets, and time are implemented in beta; object-level custom-field filters and richer cross-portfolio analytics remain.
