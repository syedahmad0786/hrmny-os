...
| Contract field                     | Evidence-backed design                                                                                                                                                                                                                                                                                                                                                                  |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Source side A — discovery          | Official `POST https://api.apollo.io/api/v1/mixed_people/api_search`. Apollo documents People API Search as 0 credits and states that it does not return email or phone data. The Sales Growth search action calls only this operation.                                                                                                                                                 |
