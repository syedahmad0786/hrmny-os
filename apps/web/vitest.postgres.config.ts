...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      "src/server/sales-os/discovery-programmes.postgres-proof.ts",
      "src/server/sales-os/discovery-runs.postgres-proof.ts",
      "src/server/sales-os/discovery-candidates.postgres-proof.ts",
      "src/server/sales-os/discovery-control.postgres-proof.ts",
      "src/server/sales-os/discovery-callbacks.postgres-proof.ts",
